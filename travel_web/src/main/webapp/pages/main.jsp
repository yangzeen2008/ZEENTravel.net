                    ...
                    <div class="table-box">
                        ...
                        <div class="pull-left">
                            <div class="form-group form-inline">
                                <div class="btn-group">
                                    <button type="button" class="btn btn-default" title="REFRESH"  onclick=location.href="${pageContext.request.contextPath}/product/findAll2.do"><i class="fa fa-refresh"></i> REFRESH</button>
                                </div>
                            </div>
                        </div>
