                ...
                <div class="row data-type">
                    ...
                    <div class="col-md-4 data">
                        <input type="text" class="form-control" name="productNum"
                            placeholder="Product Number" value="" required>
                    </div>
                    ...
                    <div class="col-md-4 data">
                        <div class="input-group date">
                            ...
                            <input type="text" class="form-control pull-right"
                                   id="dateTimePicker" name="departureTime" required>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 data">
                        <input type="text" class="form-control" name="cityName"
                               placeholder="Departure City" value="" required>
                    </div>

                    <div class="col-md-2 title">Price</div>
                    <div class="col-md-4 data">
                        <input type="number" class="form-control" name="productPrice"
                               placeholder="productPrice" value="" required>
                    </div>
