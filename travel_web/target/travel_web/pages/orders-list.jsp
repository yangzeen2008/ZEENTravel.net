                    ...
                    <div class="table-box">
                        ...
                        <div class="pull-left">
                            <div class="form-group form-inline">
                                <div class="btn-group">
                                    ...
                                    <button type="button" class="btn btn-default" title="REFRESH" onclick=location.href="${pageContext.request.contextPath}/orders/findAll.do"><i class="fa fa-refresh"></i> REFRESH</button>
                                </div>
                            </div>
                        </div>
                        ...
                        <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                            ...
                            <tr>
                                ...
                                <th class="text-center sorting">Product Price</th>
                                <th class="sorting">Ordered Time</th>
                            ...
                            <c:forEach items="${pageInfo.list}" var="orders">
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <button type="button" class="btn bg-olive btn-xs" onclick="location.href='${pageContext.request.contextPath}/orders/findById.do?id=${orders.id}'">Order Details</button>
                ...
                <div class="box-footer">
                    ...
                    <div class="box-tools pull-right">
                        <ul class="pagination">
                            ...
                            <li><a href="${pageContext.request.contextPath}/orders/findAll.do?page=${pageInfo.pageNum-1}&size=${pageInfo.pageSize}">Back</a></li>
